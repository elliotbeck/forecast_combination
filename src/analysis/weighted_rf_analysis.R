...
result_ratios_rf_long_shrinkage <- results_ratios_rf_long[
  grepl(results_ratios_rf_long$variable, pattern = "shrinkage"),
]
plot <- ggplot(
  result_ratios_rf_long_shrinkage,
  aes(x = variable, y = value, fill = variable)
) +
  geom_boxplot() +
  theme_minimal() +
...
results_ratios_rf_long_kappa_2_sample_1 <- results_ratios_rf_long[
  results_ratios_rf_long$variable == "mse_rf_weighted_shrinkage_2",
]

plot <- ggplot(
  results_ratios_rf_long_kappa_2_sample_1,
  aes(x = variable, y = value, fill = variable)
) +
  geom_boxplot() +
  theme_minimal() +
  ...
  facet_wrap(~n_obs, nrow = 1, strip.position = "bottom") +
  stat_summary(fun = mean, geom = "point", shape = 23, size = 2, fill = "red")
ggsave("results/weighted_rf_rmse_ratios_kappa_2_sample_1.pdf", plot)
...
results_ratios_rf_xgb <- results_ratios_rf_long[
  results_ratios_rf_long$variable == "mse_rf_weighted_shrinkage_2" |
    results_ratios_rf_long$variable == "mse_rf",
]
